...
Preprints
======
* **[SPA: A SQL-Plan-Aware Reinforcement Learning Framework for Query Rewriting with LLMs](https://arxiv.org/abs/2606.08620)**
  * Developed a plan-aware GRPO reward strategy, enabling Qwen-32B (LoRA) to outperform GPT-4.5 and Gemini-2.5-Pro in query rewriting by incentivizing plan change over superficial lexical changes.
